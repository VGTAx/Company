...
namespace Company.Data
{
  ...
  public class CompanyContext : IdentityDbContext<ApplicationUserModel>, ICompanyContext
  {
    ...
    {
      builder.ApplyConfiguration(new EmployeeModelTypeConfiguration());
      builder.ApplyConfiguration(new DepartmentModelTypeConfiguration());
  ...
  public sealed class EmployeeModelTypeConfiguration : IEntityTypeConfiguration<EmployeeModel>
  {
  ...
  public sealed class DepartmentModelTypeConfiguration : IEntityTypeConfiguration<DepartmentModel>
  {
