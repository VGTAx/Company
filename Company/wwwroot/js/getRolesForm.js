...
//let form = document.querySelector("#getRoles");
	...
	//	const selectedRoles = [];
	//	document.querySelectorAll('input[type="checkbox"][name="selectedRoles"]:checked').forEach(function (checkbox) {
	//		selectedRoles.push(checkbox.value);
	//	});
