    ...
    public class CompanyContext : IdentityDbContext<ApplicationUserModel>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<DepartmentModel>().HasData(
                 new DepartmentModel(1, "Отдел по обслуживанию клиентов", null, "/images/DepartmentImg/customer service department.jpg"),
                 new DepartmentModel(2, "Производственный отдел", null, "/images/DepartmentImg/production department.jpg"),
                 new DepartmentModel(3, "Бухгалтерия", null, "/images/DepartmentImg/bookkeeping.jpg"),
                 new DepartmentModel(4, "Отдел продаж", 1, "/images/DepartmentImg/sales department.jpg"),
                 new DepartmentModel(5, "Отдел оптовых продаж", 4, "/images/DepartmentImg/wholesale department.jpg"),
                 new DepartmentModel(6, "Отдел розничных продаж", 4, "/images/DepartmentImg/retail sales department.jpg"),
                 new DepartmentModel(7, "Отдел логистики", 1, "/images/DepartmentImg/logistics department.jpg"),
                 new DepartmentModel(8, "Склад", 7, "/images/DepartmentImg/stock.jpg"),
                 new DepartmentModel(9, "Отдел доставки", 7, "/images/DepartmentImg/bookkeeping.jpg"),
                 new DepartmentModel(10, "Инженерный отдел", 2, "/images/DepartmentImg/engineering department.jpg"),
                 new DepartmentModel(11, "Отдел контроля качества", 2, "/images/DepartmentImg/quality control department.jpg"),
                 new DepartmentModel(12, "Отдел закупок", 2, "/images/DepartmentImg/purchasing department.jpg")
                );      
