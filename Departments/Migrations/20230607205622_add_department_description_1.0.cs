...
{
    /// <inheritdoc />
    public partial class add_department_description_10 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, null, "Отдел по обслуживанию клиентов", null },
                    { 2, 2, null, "Производственный отдел", null },
                    { 3, 3, null, "Бухгалтерия", null },
                    { 4, 4, null, "Отдел продаж", 1 },
                    { 5, 5, null, "Отдел оптовых продаж", 4 },
                    { 6, 6, null, "Отдел розничных продаж", 4 },
                    { 7, 7, null, "Отдел логистики", 1 },
                    { 8, 8, null, "Склад", 7 },
                    { 9, 9, null, "Отдел доставки", 7 },
                    { 10, 10, null, "Инженерный отдел", 2 },
                    { 11, 11, null, "Отдел проверки качества", 2 },
                    { 12, 12, null, "Отдел закупок", 2 }
                });
